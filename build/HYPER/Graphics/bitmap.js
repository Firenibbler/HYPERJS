(function () {
    ...
    HYPER.Graphics.Bitmap = function (e) {
        ...
        this.img = e.img;
        this.width = (typeof e.width === 'undefined') ? this.img.image.width : e.width;
        this.height = (typeof e.height === 'undefined') ? this.img.image.height : e.height;

        this.sx = (typeof e.sx === 'undefined') ? 0 : e.sx;
        this.sy = (typeof e.sy === 'undefined') ? 0 : e.sy;
        this.sWidth = (typeof e.sWidth === 'undefined') ? this.img.image.width : e.sWidth;
        this.sHeight = (typeof e.sHeight === 'undefined') ? this.img.image.height : e.sHeight;
        ...
        this._render = function (o) {
            if (this.visable == true) {
                ...
                if (this.degrees != 0) {
                    ...
                    o.ctx.drawImage(this.img.image, this.sx, this.sy, this.sWidth, this.sHeight, -this.rotation.x, -this.rotation.y, this.width, this.height);

                    o.ctx.rotate(-((this.degrees * Math.PI) / 180));
                    o.ctx.translate(-(this.x - o.camera.x + this.rotation.x), -(this.y - o.camera.y + this.rotation.y));
                } else {
                    o.ctx.drawImage(this.img.image, this.sx, this.sy, this.sWidth, this.sHeight, this.x, this.y, this.width, this.height);
