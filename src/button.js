(function () {
    "use strict";
    /**
     * Create buttons with the 'new' keyword.
     * @class HYPER.Button
     * @param {object} e Object to pass all button info.
     * @param {object} e.texture bitmap or spritesheet to be rendered as the button.
     * @param {object} e.style Style info of this button.
     * @param {number} e.x=0 X location of the button.
     * @param {number} e.y=0 Y location of the button.
     * @param {number} e.width=32 Width of the button.
     * @param {number} e.height=32 Height of the button.
     * @param {number} e.angle=0 angle the button is rotated.
     * @param {number} e.rotX=0 X location of the point the button is rotated around.
     * @param {number} e.rotY=0 Y location of the point the button is rotated around.
     */
    HYPER.Button = function (e) {
        e = e || {};
        ...
        this._ID = "button " + Math.random() + "" + Math.random();
    ...
    HYPER.Button.prototype = {
         ...
         * Called by parent function.
         * @private
         * @method HYPER.Button._onDblClick
         * @param {number}data - pointer data of the click.
         */
