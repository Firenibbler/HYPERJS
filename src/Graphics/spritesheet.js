(function () {
     ...
     * @class HYPER.Graphics.SpriteSheet
     * @param {object} e Info used to create the spritesheet.
     * @param {string} e.src The sourse of the image file for the spritesheet.
     * @param {number} [e.wide = 1] The number of frames wide the spritesheet is.
     * @param {number} [e.tall = 1] The number of frames tall the spritesheet is.
     */
    HYPER.Graphics.SpriteSheet = function (e) {
        e = e || {};
        e.width = e.width || 300;
        ...
        /**
         * @property {object} bitmap - The canvas that the new sprite sheet uses.
         */

        this.bitmap = document.createElement("canvas");

        /**
         * @property {object} ctx - The context that the new sprite sheet uses.
         */
        ...
        /**
         * @property {object} animations - Contains all animation objects.
         */
    ...
    HYPER.Graphics.SpriteSheet.prototype = {
        /**
         * Draws to the bitmap, uses same methods that HYPER.Graphics.Draw uses. 
         * @method HYPER.Graphics.SpriteSheet.draw
        ...
        /**
         * Clears the bitmap.
         * @method HYPER.Graphics.SpriteSheet.clear
         */
         ...
         * @method HYPER.Graphics.SpriteSheet.setFrames
         ...
         * @method HYPER.Graphics.SpriteSheet.setFramesOBJ
         ...
         * @method HYPER.Graphics.SpriteSheet.editFrame
         ...
         * @method HYPER.Graphics.SpriteSheet.setAnimation
        ...
        /**
         * Call to update the spritesheet.
         * @method HYPER.Graphics.SpriteSheet.update
         */
        update: function () {
